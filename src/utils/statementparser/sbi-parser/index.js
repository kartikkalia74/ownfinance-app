...
function extractTransactions(text) {
    ...
    const transactionSectionMatch = text.match(/TRANSACTION DETAILS[\s\S]*?Date Transaction Reference Ref\.No\.\/Chq\.No\. Credit Debit Balance[\s\S]*?(?=\*All dates|TRANSACTION OVERVIEW|Visit https)/);
...
parseTransactions('../../pdfreader/readerfiles/ACFrOgD0Mow6cu4KWSjhYsxLYRF_jfIQKQoLgFELL8D5gelicqkCEPM-2_575xHrCE7cWfVbX8fmtHWdipr9BxZ6Vs3QZDcMQRw8vS6eBZWnAfflDU1Sb2AkaFzgT7NrI3WpWYnYSi4q2zjd1dl6CQeDFamXNrQR1_Jmys2R1A==.pdf');
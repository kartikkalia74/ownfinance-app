...
function extractTransactions(text) {
    ...
    // Find the transaction section - look for "Statement of Transactions in Savings Account"
    const transactionSectionMatch = text.match(/Statement of Transactions in Savings\s+Account[\s\S]*?DATE\s+MODE\s+PARTICULARS\s+DEPOSITS\s+WITHDRAWALS\s+BALANCE([\s\S]*?)(?=Total:|Statement of Linked Fixed Deposits|Page \d+ of \d+)/);
